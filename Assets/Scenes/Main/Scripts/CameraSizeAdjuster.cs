...
public class CameraSizeAdjuster : MonoBehaviour
{
    ...
    [SerializeField] private BaseType _baseType = BaseType.Both;

    //基準の画面サイズ
    [SerializeField] private float _baseWidth = 1280, _baseHeight = 1920;

    //画像のPixel Per Unit
    [SerializeField] private float _pixelPerUnit = 100f;

    //常に(Update中も)更新するか
    [SerializeField] private bool _isAlwaysUpdate = false;
