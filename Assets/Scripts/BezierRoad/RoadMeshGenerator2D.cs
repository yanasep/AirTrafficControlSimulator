...
namespace MeshGeneration
{
    ...
    /*************************************************************************************************/
    [ExecuteInEditMode]
    public class RoadMeshGenerator2D : MonoBehaviour
    {
            ...
            float width, float height, in List<Vector3> tangents, Part part)
        {
            ...
            Vector3 heightDir = Vector3.forward;
            ...
            for (int i = 0; i < positions.Count; i++)
            {
                ...
                var usedNormal = normalDir == NormalDirection.Upward ? Vector3.forward : prevHeightDir;
...
#if UNITY_EDITOR
    [CustomEditor(typeof(RoadMeshGenerator2D))]
    public class RoadMeshGenerator2DEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            {
                var gen = target as RoadMeshGenerator2D;
                gen.OnPathChanged();
            }
        }
    }
